...
.basement {
  ...
  .content {
    ...
    .footBtnContainer {
      ...
      .downlodaResume {
        background: #0f7C9D;
        animation: bounceUp 700ms linear 2000ms;
        -webkit-animation: bounceX 700ms linear 2000ms;
      }

      .phoneCheck {
        background: #009688;
        animation: bounceUp 700ms linear 2500ms;
        -webkit-animation: bounceX 700ms linear 2500ms;
      }
